...
function getStandaloneComponents(tree, filePath) {
    ...
    const components = (0, tsquery_1.tsquery)(ast, 'ClassDeclaration:has(Decorator > CallExpression:has(Identifier[name=Component]) ObjectLiteralExpression PropertyAssignment Identifier[name=standalone] ~ TrueKeyword) > Identifier', { visitAllChildren: true });
