...
exports.GeneratePackageJsonWebpackPlugin = void 0;
...
class GeneratePackageJsonWebpackPlugin {
    constructor(context, projectGraph, options) {
    ...
    apply(compiler) {
        ...
        compiler.hooks.thisCompilation.tap(pluginName, (compilation) => {
            compilation.hooks.processAssets.tap({
                ...
                const packageJson = (0, create_package_json_1.createPackageJson)(this.context.projectName, this.projectGraph, this.options);
...
exports.GeneratePackageJsonWebpackPlugin = GeneratePackageJsonWebpackPlugin;
//# sourceMappingURL=generate-package-json-webpack-plugin.js.map